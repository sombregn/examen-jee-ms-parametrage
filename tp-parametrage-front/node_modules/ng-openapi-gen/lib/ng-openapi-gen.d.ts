...
export declare function filterPaths(paths: OpenAPIObject['paths'], excludeTags?: Options['excludeTags'], excludePaths?: Options['excludePaths'], includeTags?: Options['includeTags']): import("@loopback/openapi-v3-types").PathsObject;
